...
public class LogisticsOrderDto {
    ...
    public LogisticsOrderDto(Long id, Long shoppingLoanOrderId, String receiveProvince, String receiveCity, String receiveArea, String receiveAddr, String receivePostNo, String receiveUsername, String receiveMobile, String logisticsCompany, String logisticsNo, String logisticsPhone, String status, Date createdAt, String createdUser, Date updatedAt, String updatedUser, Boolean dataValid, String sendProvince, String sendCity, String sendArea, String sendAddr, String sendPostNo, String sendUsername, String sendMobile, String orderType) {
        super();
        this.id = id;
