...
public class LoanOrderDto {
    ...
    public LoanOrderDto(Long id, String productFreezeNo, Integer orderAmount, Integer feeAmount, Integer interestAmount, Integer paymentAmount, Integer repaymentAmount, Integer term, String termUnit, BigDecimal termRate, Long productId, Integer productCategory, String isDepository, Boolean userType, String status, String traceNo, Long userId, String userIdcardType, String userIdcardNo, Long userBankCardId, String bankName, String bankCardNoLastFour, String userPhone, String userName, String source, String terminal, String ukToken, Date createdAt, String createdUser, Date updatedAt, String updatedUser, String specificationJson, String specificationDesc, String remark, Boolean dataValid) {
        super();
        this.id = id;
